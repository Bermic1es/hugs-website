...
import {KitchenA_ElectricCooker} from '../Category/Categories';

export const KitchenAEC = props => {
  return <div>
      <Navbar/>
      <CarouselOurProducts/>
      <VisitUs/>
        <div className={style.layout}>
          ...
          <main className={style.main}>
            <h3 className={style.heading}>Electric Cooker</h3>
            <Category data={KitchenA_ElectricCooker}/>
          </main>
        </div>
