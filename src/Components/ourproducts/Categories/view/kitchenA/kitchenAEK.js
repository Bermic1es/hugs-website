...
import {KitchenA_ElectricKettle} from '../Category/Categories';

export const KitchenAEK = props => {
  return <div>
      <Navbar/>
      <CarouselOurProducts/>
      <VisitUs/>
        <div className={style.layout}>
          ...
          <main className={style.main}>
            <h3 className={style.heading}>Electric Kettle</h3>
            <Category data={KitchenA_ElectricKettle}/>
          </main>
        </div>
