...
import {KitchenA_Grinders} from '../Category/Categories';

export const KitchenAG = props => {
  return <div>
      <Navbar/>
      <CarouselOurProducts/>
      <VisitUs/>
        <div className={style.layout}>
          ...
          <main className={style.main}>
            <h3 className={style.heading}>Grinders</h3>
            <Category data={KitchenA_Grinders}/>
          </main>
        </div>
