...
import {KitchenA_Oven} from '../Category/Categories';

export const KitchenAO = props => {
  return <div>
      <Navbar/>
      <CarouselOurProducts/>
      <VisitUs/>
        <div className={style.layout}>
          ...
          <main className={style.main}>
            <h3 className={style.heading}>Oven</h3>
            <Category data={KitchenA_Oven}/>
          </main>
        </div>
