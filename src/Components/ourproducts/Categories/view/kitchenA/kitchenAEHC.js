...
import {KitchenA_ElectricHotpotCooker} from '../Category/Categories';

export const KitchenAEHC = props => {
  return <div>
      <Helmet>
      ...
      <VisitUs/>
        <div className={style.layout}>
          ...
          <main className={style.main}>
            <h3 className={style.heading}>Electric Hotpot Cooker</h3>
            <Category data={KitchenA_ElectricHotpotCooker}/>
          </main>
        </div>
