...
import {HomeE_Television} from '../Category/Categories';

export const HomeET = props => {
  ...
  return <div>
      ...
      <div className={style.layout}>
        ...
        <main className={style.main}>
          <h3 className={style.heading}>Television</h3>
          <Category data={HomeE_Television}/>
        </main>
      </div>
