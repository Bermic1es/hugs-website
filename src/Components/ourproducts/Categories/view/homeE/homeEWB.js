...
import {HomeE_WallBracket} from '../Category/Categories';

export const HomeEWB = props => {
  ...
  return <div>
      ...
      <div className={style.layout}>
        ...
        <main className={style.main}>
          <h3 className={style.heading}>Wallbracket</h3>
          <Category data={HomeE_WallBracket}/>
        </main>
      </div>
