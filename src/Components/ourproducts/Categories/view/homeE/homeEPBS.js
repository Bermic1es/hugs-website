...
import {HomeE_PortableBluetoothSpeaker} from '../Category/Categories';

export const HomeEPBS = props => {
  ...
  return <div>
      ...
      <main className={style.main}>
        <h3 className={style.heading}>Portable Bluetooth Speaker</h3>
        <Category data={HomeE_PortableBluetoothSpeaker}/>
      </main>
      </div>
